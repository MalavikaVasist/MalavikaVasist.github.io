...
<div class="link">
  <a href="{{ '/assets/images/SecondyearThesis.pdf' | relative_url }}" target="_blank" class="link">
...
<div class="link">
  <a href="{{ '/assets/images/FirstyearThesis.pdf' | relative_url }}" target="_blank" class="link">
...
<div class="link">
  <a href="{{ '/assets/images/NN_project.pdf' | relative_url }}" target="_blank" class="link">
